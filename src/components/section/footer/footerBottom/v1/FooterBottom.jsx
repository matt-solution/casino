        ...
        <div className="v2_footer_menu">
          ...
          <div className="bottom_footer_menulist">
            <ul>
              {data?.map((item, i) => (
                <li key={i}>
                  <a href={item.url} style={{ color: "yellow" }}>{item.title} </a>
                </li>
              ))}
            </ul>
          </div>
          <div className="v2_footer_copiright_text" style={{ color: "yellow !important" }}>
            <p>Copyright ©2024 404.Casino, All rights reserved.</p>
          </div>
